...
JOBID="${1:?Usage: run_cmsdriver_mc.sh JOBID}"
INPUT_LIST="miniAODSIM_chunk_4_1${JOBID}.txt"
OUTPUT_FILE="NANOAODSIM_4_1${JOBID}.root"
CFG_FILE="RunIII2024Summer24_NanoAODv15_4_1${JOBID}.py"
SUBMIT_DIR="$PWD"
...
export EOS_OUTPUT_BASE="/eos/uscms/store/user/${EOS_USERNAME}/cms_nanoaod/mc"
